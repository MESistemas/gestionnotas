...
alter table calendarios_de_Materias add column fk_Cal_Mat int null;
alter table calendarios_de_Materias add constraint fk_Cal_Mat foreign key (fk_Cal_Mat)
references materias(id) on delete cascade;
